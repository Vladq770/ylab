...
from src.api.v1.resources import posts, signup, login, refresh, check_profile, logout
...
app.include_router(router=signup.router, prefix="/api/v1/signup")
app.include_router(router=login.router, prefix="/api/v1/login")
app.include_router(router=refresh.router, prefix="/api/v1/refresh")
app.include_router(router=check_profile.router, prefix="/api/v1/users/me")
app.include_router(router=logout.router, prefix="/api/v1/logout")
